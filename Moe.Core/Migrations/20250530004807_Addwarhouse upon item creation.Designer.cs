...
namespace Moe.Core.Migrations
{
    ...
    [Migration("20250530004807_Addwarhouse upon item creation")]
    partial class Addwarhouseuponitemcreation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moe.Core.Models.Entities.WarehouseItemTransaction", b =>
                {
                    b.HasOne("Moe.Core.Models.Entities.Warehouse", "From")
                        .WithMany()
                    ...
                    b.HasOne("Moe.Core.Models.Entities.Warehouse", "To")
                        .WithMany()
                        .HasForeignKey("ToId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
